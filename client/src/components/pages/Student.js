                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Business Analyst of Information Technology</h5>
                            <h6 className="card-subtitle mb-2 text-muted">LCA.EM</h6>
                            <p onClick={() => this.onBatchSelect('Business Analyst of Information Technology')} className="card-text" style={{
                                cursor: 'pointer',
                                color: '#00a4eb'
                            }}>Add or Check Info</p>
                        </div>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            <h5 className="card-title">Web Development and Digital Marketing</h5>
                            <h6 className="card-subtitle mb-2 text-muted">LEA.CX</h6>
                            <p onClick={() => this.onBatchSelect('Web Development and Digital Marketing')} className="card-text" style={{
                                cursor: 'pointer',
                                color: '#00a4eb'
                            }}>Add or Check Info</p>
                        </div>
                    ...
                    <div className="card" style={{ width: "12rem" }}>
                        <div className="card-body">
                            ...
                            <h6 className="card-subtitle mb-2 text-muted">LCA.EN</h6>
                            <p onClick={() => this.onBatchSelect('Supply Chain Management')} className="card-text" style={{
                                cursor: 'pointer',
                                color: '#00a4eb'
                            }}>Add or Check Info</p>
                        </div>
